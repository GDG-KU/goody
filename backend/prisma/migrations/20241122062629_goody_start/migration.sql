/*
  ...
  - You are about to drop the `club_join` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `club_waiting` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "club" DROP CONSTRAINT "club_lead_id_fkey";

-- DropForeignKey
ALTER TABLE "club_join" DROP CONSTRAINT "club_join_club_id_fkey";

-- DropForeignKey
ALTER TABLE "club_join" DROP CONSTRAINT "club_join_user_id_fkey";

-- DropForeignKey
ALTER TABLE "club_waiting" DROP CONSTRAINT "club_waiting_club_id_fkey";

-- DropForeignKey
ALTER TABLE "club_waiting" DROP CONSTRAINT "club_waiting_user_id_fkey";
...
-- DropTable
DROP TABLE "club_join";

-- DropTable
DROP TABLE "club_waiting";
